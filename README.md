# Spray
A modified version of *A Two-Continua Approach to Eulerian Simulation of Water Spray*
...
```
#### Extract Project
Extract Spray.zip to Nova/Projects. The partial directory should look like this:
```
.
+-- Projects 
|   +-- Spray
...
```
./bin/spray_2d -test_number 9 -size 128 64 -domain 8 4 -threads 8 -last_frame 3000
```
